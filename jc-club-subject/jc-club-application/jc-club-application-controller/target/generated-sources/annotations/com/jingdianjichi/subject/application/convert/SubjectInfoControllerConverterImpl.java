...
public class SubjectInfoControllerConverterImpl implements SubjectInfoControllerConverter {
    ...
    public SubjectInfoBO convertDtoToBo(SubjectInfoDTO subjectInfoDTO) {
        ...
        List<String> list = subjectInfoDTO.getLabelName();
        if ( list != null ) {
            subjectInfoBO.setLabelName( new ArrayList<String>( list ) );
        }
        ...
        List<Integer> list1 = subjectInfoDTO.getCategoryIds();
        if ( list1 != null ) {
            subjectInfoBO.setCategoryIds( new ArrayList<Integer>( list1 ) );
        }
        List<Integer> list2 = subjectInfoDTO.getLabelIds();
        if ( list2 != null ) {
            subjectInfoBO.setLabelIds( new ArrayList<Integer>( list2 ) );
        }
