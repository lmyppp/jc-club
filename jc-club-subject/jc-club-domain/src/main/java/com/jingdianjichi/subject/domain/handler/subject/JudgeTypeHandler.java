...
import com.jingdianjichi.subject.domain.convert.JudgeSubjectDomainConverter;
...
public class JudgeTypeHandler implements SubjectTypeHandler {
    ...
    public SubjectOptionBO query(int subjectId) {
        ...
        List<SubjectAnswerBO> subjectAnswerBOList = JudgeSubjectDomainConverter.INSTANCE.convertEntityToBoList(result);
